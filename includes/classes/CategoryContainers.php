...
class CategoryContainers {
    ...
    public function showBestCategories() {
        $query = $this->con->prepare("SELECT * FROM categories ORDER BY DESC LIMIT 3");
        $query->execute();
    ...
    public function showLikeCategories($categoryId) {
        $query = $this->con->prepare("SELECT * FROM categories WHERE id=:categoryI");
