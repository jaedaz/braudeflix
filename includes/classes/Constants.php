...
class Constants {
    ...
    public static $passwordNotStrong = "You should to have a Character And numbers @23DSd";

    public static $sqlInjectionAttempt = "Dont try to put an injection something!";

    public static $nonEnglishCharacters = "Non English Charter!";
}
?>