...
<div class="chart-container">
    ...
    <select id="yearSelect" onchange="updateYear(this.value)" style="padding: 10px; font-size: 16px; border: 1px solid #ccc; border-radius: 5px; background-color: #f9f9f9; color: #333;">
        <?php 
...
<script>
    // دالة لتحديث السنة المعروضة عند تغيير القيمة في القائمة المنسدلة
    ...
    if (data.length > 0) {
        ...
        document.querySelector('.chart-container').innerHTML = '<a href="bestCat.php"><p style="color:#fff;">No data available for the current year.</p></a>';
    }
</script>
</body>
</html>
